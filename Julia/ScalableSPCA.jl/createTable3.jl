...
### by rerunning the results reported in Table 3 of our paper (same as table 2, but with new inequalities).
...
println("Running pitprops data set k=5 with Problem (18s)")

k=5
lambda_true=3.406
@time UB, LB=getSDPUpperBound_gd(pitprops, k, true, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

println("Running pitprops data set k=5 with Problem (19s)")

@time UB, LB=getSDPUpperBound_d2008_gd(pitprops, k, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

k=10
println("Running pitprops data set k=10 with Problem (18s)")
lambda_true=4.173
@time UB, LB=getSDPUpperBound_gd(pitprops, k, true, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

println("Running pitprops data set k=10 with Problem (19s)")
...
println("Running wine data set k=5 with Problem (18s)")

k=5
lambda_true=3.43978
@time UB, LB=getSDPUpperBound_gd(normwine, k, true, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

println("Running wine data set k=5 with Problem (19s)")

@time UB, LB=getSDPUpperBound_d2008_gd(normwine, k, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

k=10
println("Running wine data set k=10 with Problem (18s)")
lambda_true=4.59429
@time UB, LB=getSDPUpperBound_gd(normwine, k, true, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

println("Running wine data set k=10 with Problem (19s)")
...
println("Running normMiniBooNE data set k=5 with Problem (18s)")

k=5
lambda_true=5.0000
@time UB, LB=getSDPUpperBound_gd(normminiboone, k, true, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB

println("Running normMiniBooNE data set k=5 with Problem (19s)")

@time UB, LB=getSDPUpperBound_d2008_gd(normminiboone, k, true)
@show "R-gap is:" (UB-lambda_true)/lambda_true
@show "O-gap is:" (lambda_true-LB)/LB
...
println("Running normMiniBooNE data set k=10 with Problem (19s)")
