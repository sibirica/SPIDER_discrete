...
def identify_equations(Q, reg_opts, library, threshold=1e-5, min_complexity=1,
    ...
    lib_prim_data = set([tup for term in library for tup in unpack_prims(term) if not isinstance(tup[0], ConstantTerm)]) # note that ConstantTerm won't produce anything new
