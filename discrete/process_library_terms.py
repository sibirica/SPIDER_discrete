...
def get_dims(term, ndims, dim=None, start=0, do=None, od=None):
    ...
    if od is None:
        od = [[None]*t.cgp.rank for t in term.obs_list] # the dimension of the observable to evaluate (None if the observable is rank 0)
...
# at that point it's probably easier to just write the term out manually.
